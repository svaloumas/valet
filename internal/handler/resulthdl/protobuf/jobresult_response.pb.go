...
func (x *GetJobResultResponse) GetMetadata() *structpb.Value {
	if x != nil {
		return x.Metadata
	}
	return nil
...
// Empty response
type DeleteJobResultResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}
...
func (x *DeleteJobResultResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
var file_internal_handler_resulthdl_protos_jobresult_response_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x77, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4a, 0x6f, 0x62, 0x52,
	...
	0x6f, 0x62, 0x49, 0x64, 0x12, 0x32, 0x0a, 0x08, 0x6d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x2e, 0x5a, 0x2c, 0x76, 0x61, 0x6c,
...
var file_internal_handler_resulthdl_protos_jobresult_response_proto_depIdxs = []int32{
	2, // 0: jobresult.GetJobResultResponse.metadata:type_name -> google.protobuf.Value
